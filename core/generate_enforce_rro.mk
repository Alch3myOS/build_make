...
enforce_rro_product_name := $(subst lineage_,alch3my_,$(PRODUCT_NAME))
enforce_rro_override_module := $(subst Lineage,Alch3my,$(subst lineage,alch3my,$(subst lineageos,alch3my,$(enforce_rro_source_module))))
